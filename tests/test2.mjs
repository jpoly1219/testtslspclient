...
await recursiveDefine(c, functionTypeSignature, lineNumber, indexOfRegexGroup(match, 3) + 2 - firstPatternIndex, foundSoFar, 'file:///home/jacob/projects/testtslspclient/test2.ts');
